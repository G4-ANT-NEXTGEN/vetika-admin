    ...
    <div v-if="hasSelected" class="bulk-actions">
        <div class="bulk-actions-bar">
            ...
            <div class="bulk-buttons">
                ...
                <BaseButton variant="secondary" size="sm" @click="$emit('clear')" ops=defineProps({ selectedCount: {
                    type: Number, required: true, }, hasSelected: { type: Boolean, required: true, }, showDelete: {
                    type: Boolean, default: true, }, showExport: { type: Boolean, default: true, }, }) const
                    emit=defineEmits(['delete', 'export' , 'clear' ]) const { show: showConfirm }=useConfirm() const
                    handleDelete=async ()=> {
